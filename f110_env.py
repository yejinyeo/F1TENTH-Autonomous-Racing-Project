...
class F110Env(gym.Env, utils.EzPickle):
    ...
    def step(self, action):
        ...
        # 1. 목표 좌표 변환 (픽셀 → 실제 좌표)
        goals = [[574, 593], [933, 678], [880, 507], [680, 474], [633, 392],
                [172, 305], [136, 316], [117, 341], [115, 376], [99, 397],
                [84, 414], [81, 544], [96, 575], [130, 582], [157, 571],
                [165, 544], [158, 518], [146, 495], [157, 426], [195, 389],
                [234, 372], [364, 387], [522, 418], [541, 443], [536, 476],
                [511, 493], [389, 477], [277, 465], [236, 484], [236, 529],
                [268, 555], [309, 544], [335, 524], [440, 551]]
        
        res = 0.04295 
        origin = [-55.07650228661655, -33.57884064395765] 
        height = 2000 
        for goal in goals:
